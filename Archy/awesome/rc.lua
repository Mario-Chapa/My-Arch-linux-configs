...
-- vim-like binds for the open programs menu (mod+p)
...
-- awful.key({ modkey },  2 , function() awful.menu.clients({ width=850 }) end),
...
-- Backup of the original run_once
-- function run_once(prg,arg_string)
-- 		if not prg then
-- 				do return nil end
-- 		end
...
-- end
-- -- }}}
-- if isscreen_vertical == false then
-- 	selected_paper = math.random(#beautiful.wallpaper)
-- 	gears.wallpaper.maximized(beautiful.wallpaper[selected_paper], 1, true)
-- else
-- 	gears.wallpaper.maximized(beautiful.vertical_wallpaper, 1, true)
-- end
...
-- function()
-- if isscreen_vertical == false then
-- os.execute("xrandr --output LVDS1 --rotate left")
-- else
-- os.execute("xrandr --output LVDS1 --rotate normal")
-- end
-- isscreen_vertical = not isscreen_vertical
-- end
-- ),
