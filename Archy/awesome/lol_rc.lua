...
-- }}}
	awful.util.spawn_with_shell("xcompmgr -c -C -o.1 -t-5 -l-5 -r4.2")
--	awful.util.spawn_with_shell("conky --config=/home/mario/.conkyrc-awesome")
	awful.util.spawn_with_shell("setxkbmap -layout jp")
  awful.util.spawn_with_shell("xinput set-int-prop \"Kensington Kensington Slimblade Trackball\" Evdev Axis Inversion 8 1 1")
	awful.util.spawn_with_shell("gogglesmm")
--	awful.client.movetotag(tags[9])
